...
setup(
    ...
    packages=['AWSIoTPythonSDK', 'AWSIoTPythonSDK.core',
              'AWSIoTPythonSDK.core.util', 'AWSIoTPythonSDK.core.shadow', 'AWSIoTPythonSDK.core.job',
              'AWSIoTPythonSDK.core.protocol', 'AWSIoTPythonSDK.core.protocol.paho',
              'AWSIoTPythonSDK.core.protocol.internal', 'AWSIoTPythonSDK.core.protocol.connection',
              'AWSIoTPythonSDK.core.greengrass', 'AWSIoTPythonSDK.core.greengrass.discovery',
